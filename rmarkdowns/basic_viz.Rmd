...
```{r}
## Challenge 1
ggplot(data = sdr_data, aes(x=goal_1_score, y=goal_2_score, color=goal_4_score)) +     geom_point()

# Interpretation
challenge1_interpretation = "From the dataset, the visualization shows a higher 
quantity of data around (100,6). This cluster tells me that many people that are 
less in poverty still suffer from hunger. I also observed that hunger typically 
stays within the score of 40 to 60 percent. With the added layer of goal 4, 
there is a clear difference showing (for the most part) that higher education 
reduces poverty."
...
challenge3_interpretation <- "I noticed that the countries in the Sub-Saharan
Africa regions are more in poverty than the other regions in the dataset. I also
noticed that the countries in the OECD region are all have a score above 75."
```
